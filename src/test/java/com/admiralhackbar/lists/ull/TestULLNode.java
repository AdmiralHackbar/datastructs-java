...
public class TestULLNode {
    ...
    @Test
    public void testInsertOddLength() {
    ...
    @Test
    public void testInsertEvenLength() {
        final ULLNode<Integer> node = new ULLNode<Integer>(4);
        ...
        Assert.assertEquals(3, node.get(1).intValue());
        Assert.assertEquals(3, node.get(2).intValue());
        Assert.assertEquals(2, node.get(3).intValue());
        Assert.assertEquals(4, node.getSize());
        ...
        Assert.assertNotNull(node.getNext());
        final ULLNode<Integer> next = node.getNext();
        Assert.assertEquals(3, next.get(0).intValue());
        Assert.assertEquals(2, next.get(1).intValue());
        Assert.assertEquals(2, next.getSize());
    }
